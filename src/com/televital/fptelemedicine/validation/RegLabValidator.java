...
public class RegLabValidator implements Validator{
	
	private static final Logger log4log = Logger.getLogger(RegLabValidator.class);
	 ...
	 public void validatePhoto(String photo, Errors errors)
	  {
	   ...
	   public void validateContactNumber(String contactnumber, Errors errors) {
			  ...
			  ValidationUtils.rejectIfEmptyOrWhitespace(errors, "contactDetails.contactNumber","CONTACTDETAILS_REQUIRED");
	   ...
	   public void validateEmail(String email, Errors errors) {
			  ...
			  ValidationUtils.rejectIfEmptyOrWhitespace(errors, "contactDetails.email","EMAILID_REQUIRED");
