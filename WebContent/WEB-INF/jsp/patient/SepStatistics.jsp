...
<script type="text/javascript" src="<fmt:message key="project.context"/>/applicationScript/SepStatistics.js"></script> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="pageHeadingL2">
    <tr>
        <td align="center">Date <fmt:message key="pat_from"/>&nbsp;<input name='fromDateS' id="fromDate"  size='11' maxlength="11" OnKeyPress="captureReturnKey(event)" onclick='scwShow(this,event);' readonly>&nbsp;<fmt:message key="pat_to"/>&nbsp;<input name='toDateS' id="toDate"  size='11' maxlength="11" OnKeyPress="captureReturnKey(event)"  onclick='scwShow(this,event);' readonly>
         <select name="fpN" id="fp" onChange="changeTypeFp('<fmt:message key="enteredDate_Invalid"/>','<fmt:message key="fromTodate_Invalid"/>','<c:out value="${login.loginId}"/>')"></select> <input type="button" value="Ok" name="okB" onclick="clickOK('<fmt:message key="enteredDate_Invalid"/>','<fmt:message key="fromTodate_Invalid"/>','<c:out value="${login.loginId}"/>','<fmt:message key="select_fp"/>','<fmt:message key="patients_registered"/>','<fmt:message key="pat_from"/>','<fmt:message key="pat_to"/>','<fmt:message key="patients_referred"/>');"> <input type="button" value="?" name="commHelp">
       </td>
   </tr>
</table>
<br>
