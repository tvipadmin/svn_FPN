...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="aboutusTable">
      <tr>
        <td width="75%" rowspan="2"><img src="images/collage.jpg" width="755" height="171" /></td>
        <th class="h2Home"><fmt:message key="userLogin"/></th>
      </tr>
      <tr>
        <td><br />
          &nbsp;&nbsp;<strong><fmt:message key="login.UserId"/></strong><br />
          &nbsp;
          <spring:bind path="command.loginId">
          <input maxlength="26" size="24" type="text" name="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}"/>">
          </spring:bind>
          <br />
          <br />
          &nbsp;&nbsp;<strong><fmt:message key="login.Password"/></strong><br />
          &nbsp;
          <spring:bind path="command.password">
          <input value="" maxlength="30" size="24" type="password" name="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}"/>" >
          </spring:bind>
          <br />
          <br />
          &nbsp;
          <input type="submit"  value="<fmt:message key="button.Submit"/>" />&nbsp;&nbsp;<input type="button" value="Join" onclick="javascript:joinKnow();"><input type="button" value="SendMsg" onclick="checkMsg()"></td>
      </tr>
    </table>
</form>
