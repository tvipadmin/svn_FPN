  ...
  <tr>
    <td height="31">
		<ul id="MenuBar1" class="MenuBarHorizontal">
			...
			<li><a id="fpMenu" href="<c:url value="FamilyPhysicianManagement.htm"/>" onclick="testFunction()"><fmt:message key="patient.management"/></a></li>
            </c:if>
            <c:if test="${login.person.type=='FAMILYPHYSICIAN'}">
			<li><a id="fpMenuStatistics" href="<c:url value="FamilyPhysicianStatistics.htm"/>" onclick="testFunction()"><fmt:message key="fpMenu.Statistics"/></a></li>
            </c:if> 
			<c:if test="${login.person.type=='BOTH' || login.person.type=='SPECALIST'}">
 		    <li><a id="sepMenu" href="<c:url value="SpecalistManagement.htm"/>" onclick="testFunction()"><fmt:message key="referral.patients"/></a></li>
      		</c:if>
           
            <c:if test="${login.person.type=='FAMILYPHYSICIAN'}">
			<li><a id="networkMenu" href="#"><fmt:message key="network.doctors"/>&nbsp;</a>
				<ul>
					<li><a id="sepnetMenu" href="<c:url value="SpecalistFav.htm"/>" onclick="testFunction()"><fmt:message key="specialist_heading"/></a></li>
					<li><a id="labnetMenu" href="<c:url value="LabFav.htm"/>" onclick="testFunction()"><fmt:message key="lab_heading"/></a></li>
				</ul>
			</li>
          </c:if>
          <c:if test="${login.person.type=='BOTH'}">
			<li><a id="myNetworkNew"  href="#"><fmt:message key="network.doctors"/>&nbsp;</a>
				<ul>
					<li><a id="sepnetMenu" href="<c:url value="SpecalistFav.htm"/>" onclick="testFunction()"><fmt:message key="specialist_heading"/></a></li>
					<li><a id="labnetMenu" href="<c:url value="LabFav.htm"/>" onclick="testFunction()"><fmt:message key="lab_heading"/></a></li>
                    <li><a id="fpnetMenu" href="<c:url value="MyNetwork.htm"/>" onclick="testFunction()"><fmt:message key="physicians_heading"/></a></li>
				</ul>
			</li>
          </c:if>
          <c:if test="${login.person.type=='BOTH'}">
            <li><a id="fpMenuStatistics" href="#"><fmt:message key="fpMenu.Statistics"/>&nbsp;</a>
				<ul>
					<li><a id="fpStatisticsMenu" href="<c:url value="FamilyPhysicianStatistics.htm"/>" onclick="testFunction()"><fmt:message key="fpStatistics"/></a></li>
					<li><a id="sepStatisticsMenu" href="<c:url value="SpecalistStatistics.htm"/>" onclick="testFunction()"><fmt:message key="sepStatistics"/></a></li>
				</ul>
			</li>
            </c:if> 
        </ul>
