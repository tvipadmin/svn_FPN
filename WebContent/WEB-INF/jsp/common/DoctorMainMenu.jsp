...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="navtable">
  <tr>
    <td height="31"><ul id="MenuBar1" class="MenuBarHorizontal" >
      <li><a href="<c:url value="DoctorManagement.htm"/>">&nbsp;<fmt:message key="doctor.management"/></a></li>
      <li><a href="<c:url value="LabManagement.htm"/>">&nbsp;<fmt:message key="lab.management"/></a></li>
    </ul></td>
  </tr>
</table>
<script type="text/javascript">
