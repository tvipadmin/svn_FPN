...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="navtable">
  <tr>
    <td height="31"><ul id="MenuBar1" class="MenuBarHorizontal" >
      <li><a href="<c:url value="FamilyPhysicianManagement.htm"/>" onclick="testFunction()"><fmt:message key="patient.management"/></a></li>
      <li><a href="<c:url value="SpecalistManagement.htm"/>" onclick="testFunction()"><fmt:message key="referral.patients"/></a></li>
    </ul></td>
  </tr>
</table>
<script type="text/javascript">
