...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="navtable">
  <tr>
    <td height="32"><ul id="MenuBar1" class="MenuBarHorizontal">
      <li><a id="docManage" href="<c:url value="DoctorManagement.htm"/>" onclick="testFunction()">&nbsp;<fmt:message key="doctor.management"/></a></li>
      <li><a id="labManMenu" href="<c:url value="LabManagement.htm"/>" onclick="testFunction()">&nbsp;<fmt:message key="lab.management"/></a></li>
      <li><a id="resetMainMenu" href="<c:url value="ResetLogin.htm"/>" onclick="testFunction()">&nbsp;<fmt:message key="reset.Param"/></a></li>
    </ul></td>
  </tr>
</table>
<script type="text/javascript">
