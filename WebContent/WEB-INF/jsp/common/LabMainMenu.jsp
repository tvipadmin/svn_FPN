...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="navtable">
  <tr>
    <td height="31"><ul id="MenuBar1" class="MenuBarHorizontal" >
      <li><a id="labPL" href="PatientListLabManagement.htm?idL=<c:out value="${login.loginId}"/>" onclick="testFunction()"><fmt:message key="lab.patientManagement"/></a></li>
      <li><a id="labSer" href="<c:url value="LabServicesManagement.htm"/>" onclick="testFunction()"><fmt:message key="lab.serviceManagement"/></a></li>
      <li><a id="labMenuStatistics" href="<c:url value="LabStatistics.htm"/>" onclick="testFunction()"><fmt:message key="labMenu.Statistics"/></a></li>
      <li><a  id="myNetworkLabNew" href="<c:url value="MyNetworkLab.htm"/>" onclick="testFunction()"><fmt:message key="network.doctors"/></a></li>
    </ul></td>
  </tr>
</table>
<script type="text/javascript">
