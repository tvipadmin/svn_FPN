...
<body onLoad="callMethod('history')" topmargin="0" leftmargin="0">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td><form name="PhotoUpload" method="post" action="FileUploadHistory.htm?uploadtype=history" enctype="multipart/form-data" onSubmit="setTimeout('fileupload_query_uploadstatus()', 500)" target="target_upload">
        <b><fmt:message key="history.upload"/></b><br>
