...
<body onLoad="callMethod('labreport')" topmargin="0" leftmargin="0">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td><form name="PhotoUpload" method="post" action="FileUploadLabReport.htm?uploadtype=labreport" enctype="multipart/form-data" onSubmit="setTimeout('fileupload_query_uploadstatus()', 500)" target="target_upload">
        <b><fmt:message key="labReport.upload"/></b><br>
        <fmt:message key="file.upload"/>:<br><input type="file" name="file1" id="photoUpload" onChange="document.PhotoUpload.submit()"/>
            <input type="hidden" name="photoName" id="photoNameId" value="<%=session.getValue("PhotoName") %>">
            
        </form></td>
        <td><%-- file upload progress bar --%>
