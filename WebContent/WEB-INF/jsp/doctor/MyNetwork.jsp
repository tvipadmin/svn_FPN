...
<script type="text/javascript" src="<fmt:message key="project.context"/>/applicationScript/myNetwork.js"></script>
...
<body onload="init('<fmt:message key="sure_remove"/>','<fmt:message key="not_rejected"/>','<fmt:message key="succ_rejected"/>','<fmt:message key="not_confirmed"/>','<fmt:message key="succ_confirmed"/>','<fmt:message key="not_removed"/>','<fmt:message key="succ_removed"/>','<fmt:message key="notactive"/>','<fmt:message key="newReq"/>','<fmt:message key="network.my"/>','<c:out value="${login.loginId}"/>','all'); show('ListTable'); show('ConfirmTable'); hide('successMessage'); hide('errorMessage');">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td align="right" valign="middle"><a id="reffAll" href="javascript:init('<fmt:message key="sure_remove"/>','<fmt:message key="not_rejected"/>','<fmt:message key="succ_rejected"/>','<fmt:message key="not_confirmed"/>','<fmt:message key="succ_confirmed"/>','<fmt:message key="not_removed"/>','<fmt:message key="succ_removed"/>','<fmt:message key="notactive"/>','<fmt:message key="newReq"/>','<fmt:message key="network.my"/>','<c:out value="${login.loginId}"/>','all'); show('ListTable'); show('ConfirmTable'); removeErrorMsg()" onclick="testFunction()"><fmt:message key="list.All"/></a> | <a id="reffPend" href="javascript:init('<fmt:message key="sure_remove"/>','<fmt:message key="not_rejected"/>','<fmt:message key="succ_rejected"/>','<fmt:message key="not_confirmed"/>','<fmt:message key="succ_confirmed"/>','<fmt:message key="not_removed"/>','<fmt:message key="succ_removed"/>','<fmt:message key="notactive"/>','<fmt:message key="newReq"/>','<fmt:message key="network.my"/>','<c:out value="${login.loginId}"/>','pending'); show('ListTable'); hide('ConfirmTable'); removeErrorMsg()" onclick="testFunction()"><fmt:message key="list.pending"/></a> | <a id="reffC" href="javascript: init('<fmt:message key="sure_remove"/>','<fmt:message key="not_rejected"/>','<fmt:message key="succ_rejected"/>','<fmt:message key="not_confirmed"/>','<fmt:message key="succ_confirmed"/>','<fmt:message key="not_removed"/>','<fmt:message key="succ_removed"/>','<fmt:message key="notactive"/>','<fmt:message key="newReq"/>','<fmt:message key="network.my"/>','<c:out value="${login.loginId}"/>','confirmed'); hide('ListTable'); show('ConfirmTable'); highLightReff('confirmed')" onclick="testFunction()"><fmt:message key="list.confirmed"/></a></td>
    </tr>
</table>
</div>
<div id="divPagebody">
